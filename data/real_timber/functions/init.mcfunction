...
tellraw @a [{"text":"EDTA's Real Timber datapack loaded. Beta v0.3. To use: hold sneak while cutting a tree.","color":"dark_green"},{"text":"  [Options]","color":"dark_green","bold":true,"clickEvent":{"action":"run_command","value":"/function real_timber:options"}}]
