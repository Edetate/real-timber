execute if score @s rt_oak matches 1.. run scoreboard players set $this_tree_type rt_tree_type 4
execute if score @s rt_strip_oak matches 1.. run scoreboard players set $this_tree_type rt_tree_type 4
execute if score @s rt_darkoak matches 1.. run scoreboard players set $this_tree_type rt_tree_type 3
execute if score @s rt_strip_darkoak matches 1.. run scoreboard players set $this_tree_type rt_tree_type 3
execute if score @s rt_birch matches 1.. run scoreboard players set $this_tree_type rt_tree_type 2
execute if score @s rt_strip_birch matches 1.. run scoreboard players set $this_tree_type rt_tree_type 2
execute if score @s rt_spruce matches 1.. run scoreboard players set $this_tree_type rt_tree_type 1
execute if score @s rt_strip_spruce matches 1.. run scoreboard players set $this_tree_type rt_tree_type 1
