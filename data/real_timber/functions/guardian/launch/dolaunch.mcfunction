...
execute store result score @s rt_x run data get entity @s Pos[0] 100000
execute store result score @s rt_z run data get entity @s Pos[2] 100000
...
execute store result storage edta_rt_storage launchMotion[0] double 0.00000095 run scoreboard players get $edta_rt_target rt_x
execute store result storage edta_rt_storage launchMotion[1] double 0.1 run scoreboard players get @s rt_dy
execute store result storage edta_rt_storage launchMotion[2] double 0.00000095 run scoreboard players get $edta_rt_target rt_z
