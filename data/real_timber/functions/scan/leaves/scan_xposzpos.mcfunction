...
execute unless score $current_x_div rt_scan_limit > $max_x_div rt_scan_limit unless score $current_z_div rt_scan_limit > $max_z_div rt_scan_limit run function real_timber:scan/leaves/scan
